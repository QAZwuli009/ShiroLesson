...
import cn.et.food.entity.StudentExample.Criterion;
...
public class StudentSqlProvider {
    ...
    public String insertSelective(Student record) {
        ...
        if (record.getBirthdate() != null) {
            sql.VALUES("birthdate", "#{birthdate,jdbcType=DATE}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getBirthdate() != null) {
            sql.SET("birthdate = #{record.birthdate,jdbcType=DATE}");
        }
    ...
    public String updateByPrimaryKeySelective(Student record) {
        ...
        if (record.getBirthdate() != null) {
            sql.SET("birthdate = #{birthdate,jdbcType=DATE}");
        }
